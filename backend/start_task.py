...
def main():
    ...
    manager_prompt = (
        ...
        "Your goal is to assign a task to the 'Worker' agent (agent_id: clawdbot-2).\n"
        ...
        "3. Wait for the result and report it back to me (the user)."
    )
    ...
    # We send a "user" message to trigger the bot to act.
